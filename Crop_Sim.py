...
class CropWindow(QMainWindow):
    ...
    def instantiate_crop(self):
        ...
        self.create_view_crop_layout(crop_type) #create the ciew crop growth layout
    ...
    def update_crop_view_status(self):
        ...
        self.growth_line_edit.setText(str(crop_status_report["status"]))
